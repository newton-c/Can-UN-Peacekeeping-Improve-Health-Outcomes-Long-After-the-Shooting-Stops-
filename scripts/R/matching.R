...
match_data <- d %>% select(year, ccode, hale, pko_years, pko_binary,
                     total_violence_1000, osv_1000, brd_1000, pkoxdeath,
                     pkoxosv, pkoxbrd, hdi_knn, helog_knn, civilwarborder,
                     urbangrowth_knn, gini_knn, tropical, xpolity_knn,
                     ef_knn, y05, y10, y15)
